<x-jet-action-section>
    ...
    <x-slot name="content">
        <h3 class="text-lg font-medium text-gray-900">
            @if ($this->enabled)
                @if ($showingConfirmation)
                    {{ __('فعال کردن احراز هویت دو مرحله‌ای را تمام کنید.') }}
                @else
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                {{ __('وقتی احراز هویت دو مرحله‌ای فعال باشد، در حین احراز هویت از شما خواسته می‌شود که یک نشانه امن و تصادفی را دریافت کنید. می توانید این نشانه را از برنامه Google Authenticator گوشی خود بازیابی کنید.') }}
            </p>
        </div>
