    ...
    <x-jet-dialog-modal wire:model="confirmingCategoryUpdate">
        <x-slot name="title">
            <h2 class="font-medium text-base ml-auto">
                {{ isset($this->foodCategory->id) ? 'ویرایش دسته بندی' : 'افزودن دسته بندی' }}</h2>
        </x-slot>
        ...
        <x-slot name="footer">
            ...
            <x-jet-button class="ml-2 btn btn-primary w-20" wire:click="editModal()" wire:loading.attr="disabled">
                {{ __('ذخیره') }}
            </x-jet-button>
        </x-slot>
    </x-jet-dialog-modal>
