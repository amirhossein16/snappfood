<div>
    <div class="col-span-12 mt-8">
        <div class="intro-y flex items-center h-10">
            ...
            <a href="" class="mr-auto flex items-center text-theme-26 dark:text-theme-33"> <i data-feather="refresh-ccw" class="w-4 h-4 ml-3"></i>
                به روزرسانی داده </a>
        </div>
                ...
                <div class="zoom-in w-full">
                    <div class="tiny-slider" id="important-notes" style="transform: none">
                        ...
                        <div class="h-full rounded-md">
                            <img alt="Icewall Tailwind HTML Admin Template" class="image-fit rounded-full h-full font-medium w-full flex items-center justify-center text-2xl" src="{{asset("storage/$Banner->path")}}">
                        </div>
                        @endforeach
                    </div>
                </div>
        ...
        <div class="report-box zoom-in">
            <div class="box p-5">
                <div class="flex">
                    ...
                    <div class="mr-auto">
                        <div class="report-box__indicator bg-theme-10 tooltip cursor-pointer" title="تعداد فروش"> {{$item->Orders->count()}} <i data-feather="chevron-up" class="w-4 h-4 mr-0.5"></i>
                        </div>
                    </div>
                    <div class="mr-auto">
                        @if($item->is_open)
                        <div class="report-box__indicator bg-green-500 tooltip cursor-pointer" title="وضعیت فروشگاه">
                            باز است
                            <i data-feather="chevron-up" class="w-4 h-4 mr-0.5"></i>
                        </div>
                        @else
                        <div class="report-box__indicator bg-red-500 tooltip cursor-pointer" title="وضعیت فروشگاه">
                            بسته است
                            <i data-feather="chevron-up" class="w-4 h-4 mr-0.5"></i>
                        </div>
                        @endif
        ...
        <div class="box zoom-in w-full">
            <div class="tiny-slider" id="important-notes">
                ...
                <div class="p-5">
                    ...
                    @endphp
                    <img alt="Icewall Tailwind HTML Admin Template" class="image-fit w-full" src="{{asset("/storage/photos/Foods/$filename"."_1.jpg")}}">
