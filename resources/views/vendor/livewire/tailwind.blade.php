<div>
    @if ($paginator->hasPages())
        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
            ...
            <div class="hidden sm:flex-1 sm:flex-col sm:flex sm:items-center sm:justify-between">
                <div>
...
<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="my-3">
                    <p class="text-sm block text-theme-26 dark:text-theme-33 truncate leading-5">
                        <span>{!! __('نمایش') !!}</span>
