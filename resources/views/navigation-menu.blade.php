<div>
        ...
        <ul class="border-t border-theme-2 py-5 hidden">
            <li>
                <a href="javascript:;.html" class="menu menu--active">
                    ...
                    <div class="menu__title"> دشبرد <i data-feather="chevron-down"
    ...
    <div class="top-bar-boxed border-b border-theme-2 -mt-7 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
        <div class="h-full flex items-center">
            ...
            <!-- END: Logo -->
            <!-- BEGIN: Breadcrumb -->
            <div class="-intro-x breadcrumb ml-auto"><a href=""> اپلیکیشن </a> <i data-feather="chevron-left"
                                                                                  class="breadcrumb__icon"></i> <a
                    class="breadcrumb--active">داشبرد</a></div>
            <!-- END: Breadcrumb -->
            <!-- BEGIN: Search -->
                    ...
                    <div class="search-result__content">
                        ...
                        <div class="mb-5">
                            <a href="" class="flex items-center mt-2">
                                ...
                                <div class="mr-auto w-n48 truncate text-gray-600 text-xs text-left">
