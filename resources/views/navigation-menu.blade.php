...
<div class="top-bar-boxed border-b border-theme-2 -mt-7 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
    <div class="h-full flex items-center">
        ...
        <!-- END: Logo -->
        <!-- BEGIN: Breadcrumb -->
        <div class="-intro-x breadcrumb ml-auto"> <a href=""> اپلیکیشن </a> <i data-feather="chevron-left" class="breadcrumb__icon"></i> <a class="breadcrumb--active">داشبرد</a> </div>
        <!-- END: Breadcrumb -->
        <!-- BEGIN: Search -->
        <div class="intro-x relative ml-3 sm:ml-6">
            <div class="search hidden sm:block">
                <input type="text" class="search__input form-control dark:bg-dark-1 border-transparent placeholder-theme-8" placeholder="جستجو...">
                ...
                <div class="search-result__content">
                    ...
                    <div class="mb-5">
                        <a href="" class="flex items-center mt-2">
                            ...
                            <div class="mr-3">انجلینا جولی</div>
                            <div class="mr-auto w-n48 truncate text-gray-600 text-xs text-left">angelinajolie@left4code.com</div>
                        </a>
                        <a href="" class="flex items-center mt-2">
                            <div class="w-8 h-8 image-fit">
                                <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/profile-4.jpg">
                            </div>
                            <div class="mr-3">برد پیت</div>
                            <div class="mr-auto w-n48 truncate text-gray-600 text-xs text-left">bradpitt@left4code.com</div>
                        </a>
                        <a href="" class="flex items-center mt-2">
                            <div class="w-8 h-8 image-fit">
                            ...
                            <div class="mr-auto w-n48 truncate text-gray-600 text-xs text-left">robertdeniro@left4code.com</div>
                        </a>
                        <a href="" class="flex items-center mt-2">
                            <div class="w-8 h-8 image-fit">
                            ...
                            <div class="mr-auto w-n48 truncate text-gray-600 text-xs text-left">russellcrowe@left4code.com</div>
                        </a>
                    </div>
                    <div class="search-result__content__title">محصولات</div>
                    <a href="" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/preview-4.jpg">
                        </div>
                        <div class="mr-3">اوپو فایند ایکس پرو </div>
                        <div class="mr-auto w-n48 truncate text-gray-600 text-xs text-left">گوشی هوشمند</div>
                    </a>
                    <a href="" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/preview-13.jpg">
                        </div>
                        <div class="mr-3">سونی مستر سری ای جی</div>
                        <div class="mr-auto w-n48 truncate text-gray-600 text-xs text-left">الکترونیک</div>
                    </a>
                    <a href="" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/preview-7.jpg">
                        </div>
                        <div class="mr-3">نیکون زد شش</div>
                        <div class="mr-auto w-n48 truncate text-gray-600 text-xs text-left">عکاسی</div>
                    </a>
                    <a href="" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/preview-9.jpg">
                        </div>
                        <div class="mr-3"> سامسونگ گلکسی اس20 اولترا</div>
                        <div class="mr-auto w-n48 truncate text-gray-600 text-xs text-left">گوشی هوشمند</div>
                    </a>
                </div>
            </div>
                ...
                <div class="notification-content__box dropdown-menu__content box dark:bg-dark-6">
                    ...
                    <div class="cursor-pointer relative flex items-center ">
                        <div class="w-12 h-12 flex-none image-fit ml-1">
                            <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/profile-5.jpg">
                            <div class="w-3 h-3 bg-theme-10 absolute left-0 bottom-0 rounded-full border-2 border-white"></div>
                        </div>
...
{{--                    </x-jet-nav-link>--}}
{{--                    <x-jet-nav-link href="{{ route('CommentsPanel') }}"--}}
{{--                                    :active="request()->routeIs('CommentsPanel')">--}}
{{--                        {{ __('Comments Panel') }}--}}
{{--                    </x-jet-nav-link>--}}
{{--                    @endrole--}}
{{--                    @role('superadmin')--}}
